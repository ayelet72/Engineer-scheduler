...
public class Program
{
    ...
    public static void CreateTaskes()
    {
    ...
    {
        Console.WriteLine("enter idEngineer, alias, description ,level complexity,RequiredEffortTime of the new Task");
        try
        {
